...
describe('ProposalCard', () => {
  it('renders alert title and confidence score', () => {
    ...
    // ConfidenceIndicator renders score and % in separate spans
    // Use aria-label on the gauge container instead
    expect(screen.getByLabelText('Confidence: 86%')).toBeInTheDocument()
  })
